...
//!
//! Generated from API version: 0.1.15
...
pub struct AnalyzeInputBody {
    /// Capture debug information (LLM prompts/responses). Defaults to true for analyze jobs.
    #[serde(rename = "debug")]
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct CleanerConfigInput {
    /// Cleaner name (noop, markdown, trafilatura, readability)
    pub name: String,
...
pub struct CleanerOptionsInput {
    /// Base URL for resolving relative links (readability, refyne)
    #[serde(skip_serializing_if = "Option::is_none")]
    pub base_url: Option<String>,
    /// Extract heading structure to frontmatter (refyne markdown)
    #[serde(skip_serializing_if = "Option::is_none")]
    pub extract_headings: Option<bool>,
    /// Extract images to frontmatter with {{IMG_001}} placeholders (refyne markdown)
    #[serde(skip_serializing_if = "Option::is_none")]
    pub extract_images: Option<bool>,
    /// Include images in output (trafilatura)
    #[serde(rename = "images")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub images: Option<bool>,
    /// Prepend YAML frontmatter with metadata (refyne markdown output)
    #[serde(skip_serializing_if = "Option::is_none")]
    pub include_frontmatter: Option<bool>,
    /// CSS selectors for elements to always keep (refyne)
    #[serde(skip_serializing_if = "Option::is_none")]
    pub keep_selectors: Option<serde_json::Value>,
    /// Include links in output (trafilatura)
    #[serde(rename = "links")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub links: Option<bool>,
    /// Output format (trafilatura, readability, refyne)
    #[serde(rename = "output")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub output: Option<CleanerOptionsInputOutput>,
    /// Refyne preset: default, minimal, or aggressive
    #[serde(rename = "preset")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub preset: Option<CleanerOptionsInputPreset>,
    /// CSS selectors for elements to remove (refyne)
    #[serde(skip_serializing_if = "Option::is_none")]
    pub remove_selectors: Option<serde_json::Value>,
    /// Resolve relative URLs to absolute using base_url (refyne)
    #[serde(skip_serializing_if = "Option::is_none")]
    pub resolve_urls: Option<bool>,
    /// Include tables in output (trafilatura)
    #[serde(rename = "tables")]
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct AnalyzeResponseBody {
    ...
    pub site_summary: String,
    /// YAML schema suggestion for extraction
    pub suggested_schema: String,
}
...
pub struct DebugCaptureEntry {
    ...
    /// Page content (for extract/crawl jobs)
