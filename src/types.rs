...
//!
//! Generated from API version: 0.1.25
...
pub struct AnalysisResultInput {
    ...
    /// Schema (JSON object or YAML string)
    #[serde(skip_serializing_if = "Option::is_none")]
    pub suggested_schema: Option<serde_json::Value>,
}
...
pub struct AnalyzeResponseBody {
    ...
    pub site_summary: String,
    /// Schema suggestion for extraction (JSON object)
    pub suggested_schema: serde_json::Value,
}
